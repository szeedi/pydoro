...
Welcome to `PyDoro` contributor's guide.
...
If you experience bugs or general issues with `PyDoro`, please have a look
...
You can help improve `PyDoro` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`PyDoro` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `PyDoro`'s files. While this mechanism can
...
```
conda create -n PyDoro python=3 six virtualenv pytest pytest-cov
conda activate PyDoro
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/PyDoro.git
   cd PyDoro
   ```
...
5. Install [pre-commit]:
   ...
   `PyDoro` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/PyDoro
[issue tracker]: https://github.com/<USERNAME>/PyDoro/issues
